...
cv = load_pickle(MODELS_DIR + '/reproducibility/cross_validation/cv_folds.pkl')

# Load in the lgbm gridsearch
lgbm_params = load_pickle(MODELS_DIR + '/reproducibility/challenge_params/lgb_fast_params.pkl')
